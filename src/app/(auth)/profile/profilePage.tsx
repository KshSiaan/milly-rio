    ...
    >
      <div className=" max-w-[1216px] mx-auto pt-6 lg:pt-12 pb-8 lg:pb-16 px-3 lg:px-0 ">
        <div className=" flex flex-col lg:flex-row md:flex-row  justify-between  ">
          <div>
            <h1 className=" text-[#000030] font-bold text-3xl lg:text-6xl ">
              {" "}
              {profileData.name}{" "}
            </h1>
            ...
            <div className="flex items-center gap-2.5 mt-2.5 ">
              ...
              <div>
                <span className=" block text-[#000030] text-xl ">
                  {" "}
                  {profileData.email}{" "}
                </span>
              </div>
            ...
            <div className="flex lg:flex-row  items-center mt-2.5 gap-2.5 ">
              ...
              <div>
                <p className=" block text-[#000030] text-xl ml-5 ">
                  {" "}
                  <strong>Age</strong> {profileData.age} years old{" "}
                </p>
              </div>
            </div>
            <div className=" mt-5 lg:mt-9 flex flex-col items-center md:flex-row lg:flex-row gap-3 lg:mb-0 md:mb-0 mb-7  ">
              <div>
                <Link href={`/profile/${profileData.id}`}>
                  <Button className=" bg-[#FFC107] w-[182px] h-[44px] hover:bg-amber-400 text-[#FFFFFF] font-bold text-xl ">
                    Edit profile
                  </Button>
                </Link>
              </div>
              <div>
                <Button className=" w-[182px] h-[44px] bg-white hover:bg-white border border-[#FF0302]  font-bold text-xl text-[#FF0302] ">
                  Log out
                </Button>
              </div>
            </div>
        ...
        <div className="lg:mt-7 md:mt-3 mt-2  ">
          ...
          <p className=" text-[#000030] text-xl font-thin mt-2.5 lg:text-start text-justify  ">
            {profileData.about}
          </p>
        </div>
        {/* purchase product  */}
            ...
            {productList.map((item, i) => {
              return (
                <motion.div
                  ...
                  key={i}
                  className="  gap-6 rounded-[10px] shadow shadow-[#00000026] bg-white  "
                >
                  <div className="flex lg:flex-row flex-col gap-x-14 p-4  ">
                    <div className="  ">
                      <h1 className=" text-[#000030] text-xl font-bold ">
                        {" "}
                        Product: {item.name}{" "}
                      </h1>
                      <p className="  mt-2 mb-8 lg:text-start text-justify ">
                        {" "}
                        {item.description}{" "}
                      </p>
                    </div>
