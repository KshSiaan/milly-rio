  ...
  return (
    ...
    >
      ...
      >
        ...
        <form>
          <motion.fieldset
            ...
            className={`relative border border-gray-300 rounded-lg !px-3 !py-2 transition-all ${
              nameFocused || name ? "border-blue-500" : ""
            }`}
          >
            {/* Full Name */}
          ...
          <motion.fieldset
            ...
            className={`relative border !mt-4 border-gray-300 rounded-lg !px-3 !py-2 transition-all ${
        ...
        <motion.div
          className="flex justify-center items-center !mt-2 text-[#000030] text-sm"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.5 }}
        >
          Have an account?{" "}
          <Link className=" text-[#FFC107] font-semibold text-sm" href="/login">
            {" "}
            Sign In{" "}
          </Link>
        </motion.div>
