...
const BlogPage = () => {
  ...
  return (
    <div className="bg-[#f5f8fc] pt-10 pb-16">
      <div className="max-w-[1216px] mx-auto px-4">
        ...
        >
          <h1 className="text-[#000030] font-semibold text-3xl mb-6">Latest Blogs</h1>
        </motion.div>
        ...
        >
          {blogList.map((blog, index) => (
            ...
            >
              ...
              />
              <div className="mt-4">
                <h2 className="text-[#000030] font-semibold text-lg">{blog.title}</h2>
                <p className="mt-2 text-[#6D6D6D] text-sm">{blog.description}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>
