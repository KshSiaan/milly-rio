...
const fun: FunData[] = [
  {
    ...
    description:
      "Help Rio use his super sniffer to detect hidden objects and alert Milly when it’s time to check her glucose levels! Can you complete all the challenges?",
  },
  {
    id: 2,
    title: "✅ Milly’s Magical Maze 🏃‍♀️🛑",
    description:
      "Guide Milly & Rio through a fun maze inside the hospital as they find their way to the diabetes clinic. Watch out for tricky turns!",
  },
  {
    id: 3,
    title: "✅ Find the Hidden Objects 🔎✨",
    description:
      "Search for hidden diabetes care tools, healthy snacks, and fun surprises in an exciting interactive scene! Can you find them all?",
  },
  {
    id: 4,
    title: "✅ Super Sniffer Hide & Seek 👀🐾",
    description:
      "Rio is hiding—can you find him? Solve the clues and learn about diabetes care tools along the way!",
  },
  {
    id: 5,
    title: "✅ Coloring Pages & Printables 🎨🖍️",
    description:
      "Download and print fun coloring pages featuring Milly, Rio, and their adventures! Grab your crayons and get creative!",
  },
  {
    id: 6,
    title: "✅ Milly’s Magical CGM Game ⏳📲",
    description:
      "Learn how Milly’s Continuous Glucose Monitor (CGM) works in a fun, interactive way. Help Milly track her blood sugar and stay active!",
  },
];
  ...
  return (
    <div className="bg-[#f5f8fc] !pt-10 !pb-24">
      <div className="max-w-[1216px] !mx-auto lg:!px-2 !px-4">
        ...
        >
          <h1 className="text-3xl text-[#000030] font-semibold">
            Welcome to the Fun Zone! 🚀✨
          </h1>
          <p className="text-sm text-[#000030] mt-4">
            Join Milly & Rio on exciting adventures with fun, interactive
            activities designed just for kids! This page is packed with engaging
            games, puzzles, and challenges that make learning about Type 1
            Diabetes fun and easy.
          </p>
        </motion.div>
          ...
          <div className="mt-4 space-y-4">
            {fun.map((item, index) => (
              ...
              >
                ...
                <p className="text-sm text-[#000030] !mt-1.5">
                  {item.description}
                </p>
              </motion.div>
            ))}
        ...
        <motion.div
          ...
          className="mt-10"
        >
          <h2 className="text-[#000030] text-2xl font-semibold">
                ...
                {index % 2 == 0 ? (
                  <div>
                    <Link className="" href={`/funActivities/${item.id}`}>
                      <Image
                        ...
                        alt={item.title}
                      />
                      <h3 className="text-sm text-center lg:text-start text-[#000030] !mt-2">
                        {item.title}
                      </h3>
                    </Link>
                  </div>
                  ...
                  <div>
                    <Image
                      ...
                      alt={item.title}
                    />
                    <h3 className="text-sm text-[#000030] text-center lg:text-start !mt-2 font-bold">
                      {item.title}
                    </h3>
                  </div>
                )}
