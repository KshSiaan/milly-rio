    ...
    <div className="bg-[#f5f8fc]">
      <div className="max-w-[1216px] !mx-auto !pt-7 lg:pt-[63px] pb-14 lg:pb-[134px] px-4 sm:px-6 lg:px-0">
        ...
        <div>
          ...
          >
            Milly and Rio are excited for you to bring their world to life with
            your creativity! Grab your favorite crayons, colored pencils, or
            markers and get ready for some coloring fun!🖍️
          </motion.h1>
          ...
          >
            <ul className="list-decimal ml-4">
              ...
              >
                Ask a Parent or Guardian to Print the Page! 🖨️ Before you start,
                make sure an adult helps you print the coloring page.
              </motion.li>
              ...
              >
                Pick Your Favorite Colors! Milly’s world is full of bright and
                fun colors. You can color her outfit, Rio’s fur, and even the
                background however you like! 🌈
              </motion.li>
              ...
              >
                Use Your Imagination! Want to add extra details? Maybe a
                rainbow, a park, or some diabetes-friendly snacks for Milly? Get
                creative! ✨
              </motion.li>

              <motion.li
                className="text-[#000030] text-[16px] !smt-4"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 0.7, delay: 1.4 }}
              >
                Show Off Your Work! Ask an adult to take a picture of your
                finished artwork and share it with us on Facebook 🎉
              </motion.li>
            </ul>
          </motion.div>
          ...
          >
            ...
            >
              🎨 Fun Idea: Print a few copies and see how many different
              versions of Milly & Rio you can create!
            </motion.h1>
            <motion.h1
