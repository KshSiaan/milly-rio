  ...
  const books: BookData[] = [
    {
      id: 1,
      img: "/book1.png",
      title: "The ABCs Adventures - Type 1 Diabetes",
    },
    { id: 2, img: "/book2.png", title: "Rio’s Super Sniffer Adventure Milly" },
    {
      id: 3,
      img: "/book3.png",
      title: "Hospital Adventure - The ABC’s Of Type 1 Diabetes",
    },
    {
      id: 4,
      img: "/book4.png",
      ...
      >
        ...
        <motion.div className="text-center">
          ...
          <p className="!mt-2 text-[#000030] text-base">
            Get ready to dive into adventure, learning, and fun with Milly &
            Rio! Whether you’re solving mysteries, exploring new places, or
            learning about Type 1 Diabetes in the most exciting way, these books
            are packed with heartwarming stories and valuable lessons.
          </p>
          <span className="!mt-4 text-[#000030] text-base block">
            Grab your favorite book, curl up with Rio (or your own furry
            friend!), and let the adventure begin! Which story will you explore
            first? 🚀🐶✨
          </span>
        </motion.div>
